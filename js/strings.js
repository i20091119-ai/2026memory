...
export const STR = {
  ...
  TITLE_KEYHINT: (keys) => `키보드 ${keys} = 빨 노 초 파`,
  ...
  /* 완주 화면의 "당신의 기억폭" 카드 — 수학문화관다운 마무리.
     이 게임의 최대치 4개가 인지과학이 말하는 작업기억 용량(코완, 2001)과
     맞아떨어진다. 그래서 완주 = 사람의 한계까지 채운 것으로 해설한다.
     게임오버에는 넣지 않는다 — 15초 카운트다운 안에 읽기 빠듯하다. */
  SPAN_LABEL: '당신의 기억폭',
  SPAN_MAX: '최대!',
  SPAN_FACT: (n) => `과학자들이 말하는 사람의 한계 ${n}개를 꽉 채웠어요! 이보다 길면 누구든 '묶어서' 외워야 해요.`,
  SPAN_FACT_STRONG: (n) => `사람의 한계 ${n}개`,
  SPAN_TIP: '숫자만 따로 재면 어른은 보통 7±2개 (밀러, 1956). 다음엔 숫자 게임으로 확인해 볼까?',
  SPAN_TIP_STRONG: '7±2개',
  ...
  /* 2인 대결 — 흰색 버튼으로 옆 좌석에 도전 */
  CHALLENGE_INCOMING: '옆 사람이 도전을 신청했어요!',
  CHALLENGE_QUESTION: '도전에 응하시겠습니까?',
  CHALLENGE_ACCEPT_HINT: '흰색 버튼 = 수락',
  CHALLENGE_IGNORE_HINT: '하던 걸 계속하면 지나가요',
  CHALLENGE_SENT: '도전장을 보냈어요!',
  CHALLENGE_WAITING: '옆 사람의 대답을 기다리는 중…',
  CHALLENGE_DECLINED: '옆 사람이 응하지 않았어요',
  CHALLENGE_ACCEPTED: '도전 수락!',
  VS_PICK_TITLE: '무슨 게임으로 겨룰까?',
  VS_PICK_SUB: '먼저 누르는 사람이 정해요 · 8초가 지나면 혼합',
  VS_INTRO_TITLE: '대결!',
  VS_INTRO_RULE: (n) => `같은 문제가 동시에 나와요. 먼저 다 맞힌 사람이 1점 — 먼저 ${n}점을 따면 승리!`,
  VS_INTRO_FLOW: '1개 → 2개 → 3개 → 4개 기억 · 8라운드',
  VS_INTRO_WRONG: '틀리면 그 라운드는 상대 것!',
  VS_BAR_ME: '나',
  VS_BAR_OPP: '상대',
  VS_BAR_ROUND: (n, total) => `라운드 ${n}/${total}`,
  VS_BAR_SUDDEN: '서든데스',
  VS_OPP_PROGRESS: '상대',
  VS_WAIT_TITLE: '땡!',
  VS_WAIT_SUB: '옆 사람을 기다려요…',
  VS_ROUND_WON: '내가 먼저!',
  VS_ROUND_LOST: '옆 사람이 먼저!',
  VS_ROUND_DRAW: '둘 다 땡! 다시!',
  VS_ROUND_SUDDEN: '동점! 서든데스!',
  VS_WIN: '승리!',
  VS_LOSE: '아쉽다!',
  VS_WIN_CHEER: '기억력 대결 챔피언!',
  VS_LOSE_CHEER: '다음엔 이길 수 있어!',
  VS_RESULT_PRESS: '아무 버튼이나 눌러 타이틀로',
  VS_ADMIN_COUNT: (n) => `대결 ${n.toLocaleString('ko-KR')}판`,
